...
# Runs on the HOST machine to play sounds requested by peon-ping in devcontainers.
#
# Usage:
...
#
# The relay receives HTTP requests from the container and plays audio
...
for arg in "$@"; do
  case "$arg" in
    ...
    --help|-h)
      ...
      echo "Devcontainers send audio requests to this relay for playback."
      echo ""
      echo "Options:"
