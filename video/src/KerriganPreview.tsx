...
const TIMELINE = [
  ...
  // Type prompt
  { frame: 170, type: "line" as const, text: "> Scan the codebase for security vulnerabilities", style: "cmd" as const },
  // Working...
  ...
  return (
    <div
      style={{
        ...
        boxShadow: "0 0 60px rgba(0,0,0,0.6), 0 0 2px rgba(124,58,237,0.15)",
      }}
    >
      {/* Title bar */}
      <div
...
const TitleCard: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, background: PURPLE }} />
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 4, background: PURPLE }} />
      <div
        style={{
          display: "flex",
      ...
      >
        <div style={{ fontFamily: "monospace", fontSize: 22, color: PURPLE, letterSpacing: 6, textTransform: "uppercase", marginBottom: 16, opacity: subSpring }}>
                ...
                return (
                  <TermLine key={i} appearFrame={event.frame}>
                    {event.style === "cmd" ? (
                      ...
                      <span style={{ color: PURPLE }}>{event.text}</span>
                    ) : event.style === "cursor" ? (
                      <span>
